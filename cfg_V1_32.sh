...
#SBATCH --output=../MetaBreast/logs/medical_diffusion/V1/output.out           # Filename with STDOUT. You can use special flags, such as %N and %j.
#SBATCH --error=../MetaBreast/logs/medical_diffusion/V1/error.err             # (Optional) Filename with STDERR. If ommited, use STDOUT.
