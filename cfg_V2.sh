...
#python train/train_ddpm.py model=ddpm dataset=default model.results_folder_postfix='own_dataset' model.vqgan_ckpt=../../../../nas-ctm01/homes/pfsousa/MedDiff/V1/own_dataset/lightning_logs/version_6008/checkpoints/latest_checkpoint.ckpt model.diffusion_img_size=64 model.diffusion_depth_size=30 model.diffusion_num_channels=8 model.dim_mults=[1,2,4,8] model.batch_size=2 model.gpus=1
