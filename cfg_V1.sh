...
python train/train_ddpm.py model=ddpm dataset=default model.results_folder_postfix='own_dataset' model.vqgan_ckpt=../../../../nas-ctm01/homes/pfsousa/MedDiff/DEFAULT/own_dataset/lightning_logs/version_5577/checkpoints/latest_checkpoint.ckpt model.diffusion_img_size=64 model.diffusion_depth_size=15 model.diffusion_num_channels=64 model.dim_mults=[1,2,4,8] model.batch_size=5 model.gpus=1
